...
var makeTest = function(tx, traceConfig) {
    ...
    var block   = sil.getBlock(sil.getTransaction(tx).blockHash);
    var genesis = sil.getBlock(block.parentHash);
    ...
    genesis.config = admin.nodeInfo.protocols.sil.config;
    ...
    var data = {
        genesis: genesis,
        context: context,
        input:   sil.getRawTransaction(tx),
        result:  result,
    };
