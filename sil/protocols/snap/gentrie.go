...
func newPathTrie(owner common.Hash, skipLeftBoundary bool, db sildb.KeyValueReader, batch sildb.Batch) *pathTrie {
	tr := &pathTrie{
		owner:            owner,
...
func newHashTrie(batch sildb.Batch) *hashTrie {
