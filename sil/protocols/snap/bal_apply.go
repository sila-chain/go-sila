...
// individual slot write. This holds post SIP-6780: pre-existing contracts can
...
func (s *syncerV2) applyAccessList(b *bal.BlockAccessList, batch sildb.Batch) error {
