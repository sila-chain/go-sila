...
func getChain() *core.BlockChain {
	...
	_, blocks, _ := core.GenerateChainWithGenesis(gspec, silash.NewFaker(), 2, func(i int, gen *core.BlockGen) {})
	...
	bc, _ := core.NewBlockChain(rawdb.NewMemoryDatabase(), gspec, silash.NewFaker(), options)
