...
// sila.SyncProgress. The two syncer versions report it via different types
...
// state syncers, consumed by sil/downloader. Peers are passed as SyncPeerV2,
...
func NewV1Syncer(db sildb.Database, scheme string) Syncer {
	return syncerV1Adapter{newSyncer(db, scheme)}
}

// NewV2Syncer returns a Syncer backed by the snap/2 state syncer.
func NewV2Syncer(db sildb.Database, scheme string) Syncer {
