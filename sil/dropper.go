...
var (
	...
	droppedInbound = metrics.NewRegisteredMeter("sil/dropper/inbound", nil)
	// droppedOutbound is the number of outbound peers dropped
	droppedOutbound = metrics.NewRegisteredMeter("sil/dropper/outbound", nil)
	...
	dropSkipped = metrics.NewRegisteredMeter("sil/dropper/skipped", nil)
)
