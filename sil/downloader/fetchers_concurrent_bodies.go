...
func (q *bodyQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *sil.Response) (*sil.Request, error) {
...
func (q *bodyQueue) deliver(peer *peerConnection, packet *sil.Response) (int, error) {
	resp := packet.Res.(*sil.BlockBodiesResponse)
	meta := packet.Meta.(sil.BlockBodyHashes)
