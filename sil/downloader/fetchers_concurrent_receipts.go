...
func (q *receiptQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *sil.Response) (*sil.Request, error) {
...
func (q *receiptQueue) deliver(peer *peerConnection, packet *sil.Response) (int, error) {
	receipts := *packet.Res.(*sil.ReceiptsRLPResponse)
