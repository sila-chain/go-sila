...
func (tc *testChain) generate(n int, seed byte, parent *types.Block, heavy bool) {
	blocks, _ := core.GenerateChain(testGspec.Config, parent, silash.NewFaker(), testDB, n, func(i int, block *core.BlockGen) {
...
func newTestBlockchain(blocks []*types.Block) *core.BlockChain {
	...
	tbc.gen.Do(func() {
		...
		chain, err := core.NewBlockChain(rawdb.NewMemoryDatabase(), testGspec, silash.NewFaker(), nil)
		if err != nil {
			panic(err)
		}
