...
// Package silclient provides a client for the Sila RPC API.
package silclient
...
// Client defines typed wrappers for the Sila RPC API.
type Client struct {
	c *rpc.Client
}
...
func (ec *Client) ChainID(ctx context.Context) (*big.Int, error) {
	...
	err := ec.c.CallContext(ctx, &result, "sil_chainId")
	if err != nil {
		return nil, err
	}
...
func (ec *Client) BlockByHash(ctx context.Context, hash common.Hash) (*types.Block, error) {
	return ec.getBlock(ctx, "sil_getBlockByHash", hash, true)
}
...
func (ec *Client) BlockByNumber(ctx context.Context, number *big.Int) (*types.Block, error) {
	return ec.getBlock(ctx, "sil_getBlockByNumber", toBlockNumArg(number), true)
}

// BlockNumber returns the most recent block number
func (ec *Client) BlockNumber(ctx context.Context) (uint64, error) {
	var result hexutil.Uint64
	err := ec.c.CallContext(ctx, &result, "sil_blockNumber")
...
func (ec *Client) BlockReceipts(ctx context.Context, blockNrOrHash rpc.BlockNumberOrHash) ([]*types.Receipt, error) {
	var r []*types.Receipt
	err := ec.c.CallContext(ctx, &r, "sil_getBlockReceipts", blockNrOrHash)
	if err == nil && r == nil {
	...
	if len(body.UncleHashes) > 0 {
		...
		for i := range reqs {
			reqs[i] = rpc.BatchElem{
				Method: "sil_getUncleByBlockHashAndIndex",
...
func (ec *Client) HeaderByHash(ctx context.Context, hash common.Hash) (*types.Header, error) {
	var head *types.Header
	err := ec.c.CallContext(ctx, &head, "sil_getBlockByHash", hash, false)
	if err == nil && head == nil {
		err = sila.NotFound
	}
	return head, err
...
func (ec *Client) HeaderByNumber(ctx context.Context, number *big.Int) (*types.Header, error) {
	var head *types.Header
	err := ec.c.CallContext(ctx, &head, "sil_getBlockByNumber", toBlockNumArg(number), false)
	if err == nil && head == nil {
		err = sila.NotFound
	}
	return head, err
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	err = ec.c.CallContext(ctx, &json, "sil_getTransactionByHash", hash)
	if err != nil {
...
func (ec *Client) TransactionSender(ctx context.Context, tx *types.Transaction, block common.Hash, index uint) (common.Address, error) {
	...
	if err = ec.c.CallContext(ctx, &meta, "sil_getTransactionByBlockHashAndIndex", block, hexutil.Uint64(index)); err != nil {
...
func (ec *Client) TransactionCount(ctx context.Context, blockHash common.Hash) (uint, error) {
	...
	err := ec.c.CallContext(ctx, &num, "sil_getBlockTransactionCountByHash", blockHash)
	return uint(num), err
}
...
func (ec *Client) TransactionInBlock(ctx context.Context, blockHash common.Hash, index uint) (*types.Transaction, error) {
	var json *rpcTransaction
	err := ec.c.CallContext(ctx, &json, "sil_getTransactionByBlockHashAndIndex", blockHash, hexutil.Uint64(index))
	if err != nil {
		return nil, err
	}
	if json == nil {
...
func (ec *Client) TransactionReceipt(ctx context.Context, txHash common.Hash) (*types.Receipt, error) {
	var r *types.Receipt
	err := ec.c.CallContext(ctx, &r, "sil_getTransactionReceipt", txHash)
	if err == nil && r == nil {
		return nil, sila.NotFound
	}
	return r, err
...
func (ec *Client) SubscribeTransactionReceipts(ctx context.Context, q *sila.TransactionReceiptsQuery, ch chan<- []*types.Receipt) (sila.Subscription, error) {
	sub, err := ec.c.SilSubscribe(ctx, ch, "transactionReceipts", q)
	if err != nil {
		return nil, err
	}
	return sub, nil
...
func (ec *Client) SyncProgress(ctx context.Context) (*sila.SyncProgress, error) {
	var raw json.RawMessage
	if err := ec.c.CallContext(ctx, &raw, "sil_syncing"); err != nil {
		return nil, err
	}
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (sila.Subscription, error) {
	sub, err := ec.c.SilSubscribe(ctx, ch, "newHeads")
	if err != nil {
...
func (ec *Client) BalanceAt(ctx context.Context, account common.Address, blockNumber *big.Int) (*big.Int, error) {
	var result hexutil.Big
	err := ec.c.CallContext(ctx, &result, "sil_getBalance", account, toBlockNumArg(blockNumber))
	return (*big.Int)(&result), err
}
...
func (ec *Client) BalanceAtHash(ctx context.Context, account common.Address, blockHash common.Hash) (*big.Int, error) {
	var result hexutil.Big
	err := ec.c.CallContext(ctx, &result, "sil_getBalance", account, rpc.BlockNumberOrHashWithHash(blockHash, false))
	return (*big.Int)(&result), err
}
...
func (ec *Client) StorageAt(ctx context.Context, account common.Address, key common.Hash, blockNumber *big.Int) ([]byte, error) {
	...
	err := ec.c.CallContext(ctx, &result, "sil_getStorageAt", account, key, toBlockNumArg(blockNumber))
	return result, err
}
...
func (ec *Client) StorageAtHash(ctx context.Context, account common.Address, key common.Hash, blockHash common.Hash) ([]byte, error) {
	var result hexutil.Bytes
	err := ec.c.CallContext(ctx, &result, "sil_getStorageAt", account, key, rpc.BlockNumberOrHashWithHash(blockHash, false))
	return result, err
}
...
func (ec *Client) CodeAt(ctx context.Context, account common.Address, blockNumber *big.Int) ([]byte, error) {
	var result hexutil.Bytes
	err := ec.c.CallContext(ctx, &result, "sil_getCode", account, toBlockNumArg(blockNumber))
	return result, err
}
...
func (ec *Client) CodeAtHash(ctx context.Context, account common.Address, blockHash common.Hash) ([]byte, error) {
	var result hexutil.Bytes
	err := ec.c.CallContext(ctx, &result, "sil_getCode", account, rpc.BlockNumberOrHashWithHash(blockHash, false))
	return result, err
}
...
func (ec *Client) NonceAt(ctx context.Context, account common.Address, blockNumber *big.Int) (uint64, error) {
	var result hexutil.Uint64
	err := ec.c.CallContext(ctx, &result, "sil_getTransactionCount", account, toBlockNumArg(blockNumber))
	return uint64(result), err
}
...
func (ec *Client) NonceAtHash(ctx context.Context, account common.Address, blockHash common.Hash) (uint64, error) {
	var result hexutil.Uint64
	err := ec.c.CallContext(ctx, &result, "sil_getTransactionCount", account, rpc.BlockNumberOrHashWithHash(blockHash, false))
	return uint64(result), err
}
...
func (ec *Client) FilterLogs(ctx context.Context, q sila.FilterQuery) ([]types.Log, error) {
	...
	err = ec.c.CallContext(ctx, &result, "sil_getLogs", arg)
	return result, err
}
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q sila.FilterQuery, ch chan<- types.Log) (sila.Subscription, error) {
	...
	sub, err := ec.c.SilSubscribe(ctx, ch, "logs", arg)
	if err != nil {
		// Defensively prefer returning nil interface explicitly on error-path, instead
		// of letting default golang behavior wrap it with non-nil interface that stores
		// nil concrete type value.
...
func toFilterArg(q sila.FilterQuery) (interface{}, error) {
	...
	// (e.g. Hedera, some non-Sila implementations).
...
func (ec *Client) PendingBalanceAt(ctx context.Context, account common.Address) (*big.Int, error) {
	var result hexutil.Big
	err := ec.c.CallContext(ctx, &result, "sil_getBalance", account, "pending")
	return (*big.Int)(&result), err
}
...
func (ec *Client) PendingStorageAt(ctx context.Context, account common.Address, key common.Hash) ([]byte, error) {
	var result hexutil.Bytes
	err := ec.c.CallContext(ctx, &result, "sil_getStorageAt", account, key, "pending")
	return result, err
}
...
func (ec *Client) PendingCodeAt(ctx context.Context, account common.Address) ([]byte, error) {
	var result hexutil.Bytes
	err := ec.c.CallContext(ctx, &result, "sil_getCode", account, "pending")
	return result, err
}
...
func (ec *Client) PendingNonceAt(ctx context.Context, account common.Address) (uint64, error) {
	var result hexutil.Uint64
	err := ec.c.CallContext(ctx, &result, "sil_getTransactionCount", account, "pending")
	return uint64(result), err
}
...
func (ec *Client) PendingTransactionCount(ctx context.Context) (uint, error) {
	var num hexutil.Uint
	err := ec.c.CallContext(ctx, &num, "sil_getBlockTransactionCountByNumber", "pending")
	return uint(num), err
}
...
func (ec *Client) CallContract(ctx context.Context, msg sila.CallMsg, blockNumber *big.Int) ([]byte, error) {
	...
	err := ec.c.CallContext(ctx, &hex, "sil_call", toCallArg(msg), toBlockNumArg(blockNumber))
	if err != nil {
		return nil, err
	}
	return hex, nil
...
func (ec *Client) CallContractAtHash(ctx context.Context, msg sila.CallMsg, blockHash common.Hash) ([]byte, error) {
	var hex hexutil.Bytes
	err := ec.c.CallContext(ctx, &hex, "sil_call", toCallArg(msg), rpc.BlockNumberOrHashWithHash(blockHash, false))
	if err != nil {
		return nil, err
	}
	return hex, nil
...
func (ec *Client) PendingCallContract(ctx context.Context, msg sila.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
	err := ec.c.CallContext(ctx, &hex, "sil_call", toCallArg(msg), "pending")
	if err != nil {
		return nil, err
	}
	return hex, nil
...
func (ec *Client) SuggestGasPrice(ctx context.Context) (*big.Int, error) {
	var hex hexutil.Big
	if err := ec.c.CallContext(ctx, &hex, "sil_gasPrice"); err != nil {
		return nil, err
	}
...
func (ec *Client) SuggestGasTipCap(ctx context.Context) (*big.Int, error) {
	var hex hexutil.Big
	if err := ec.c.CallContext(ctx, &hex, "sil_maxPriorityFeePerGas"); err != nil {
		return nil, err
	}
	return (*big.Int)(&hex), nil
}
...
func (ec *Client) BlobBaseFee(ctx context.Context) (*big.Int, error) {
	var hex hexutil.Big
	if err := ec.c.CallContext(ctx, &hex, "sil_blobBaseFee"); err != nil {
		return nil, err
	}
	return (*big.Int)(&hex), nil
}
...
func (ec *Client) FeeHistory(ctx context.Context, blockCount uint64, lastBlock *big.Int, rewardPercentiles []float64) (*sila.FeeHistory, error) {
	...
	if err := ec.c.CallContext(ctx, &res, "sil_feeHistory", hexutil.Uint(blockCount), toBlockNumArg(lastBlock), rewardPercentiles); err != nil {
		return nil, err
	}
...
func (ec *Client) EstimateGas(ctx context.Context, msg sila.CallMsg) (uint64, error) {
	...
	err := ec.c.CallContext(ctx, &hex, "sil_estimateGas", toCallArg(msg))
	if err != nil {
		return 0, err
	}
...
func (ec *Client) EstimateGasAtBlock(ctx context.Context, msg sila.CallMsg, blockNumber *big.Int) (uint64, error) {
	var hex hexutil.Uint64
	err := ec.c.CallContext(ctx, &hex, "sil_estimateGas", toCallArg(msg), toBlockNumArg(blockNumber))
	if err != nil {
		return 0, err
	}
	return uint64(hex), nil
...
func (ec *Client) EstimateGasAtBlockHash(ctx context.Context, msg sila.CallMsg, blockHash common.Hash) (uint64, error) {
	var hex hexutil.Uint64
	err := ec.c.CallContext(ctx, &hex, "sil_estimateGas", toCallArg(msg), rpc.BlockNumberOrHashWithHash(blockHash, false))
	if err != nil {
		return 0, err
	}
	return uint64(hex), nil
...
func (ec *Client) SendTransaction(ctx context.Context, tx *types.Transaction) error {
	...
	return ec.c.CallContext(ctx, nil, "sil_sendRawTransaction", hexutil.Encode(data))
}
...
func (ec *Client) SendRawTransactionSync(
	...
	if err := ec.c.CallContext(ctx, &receipt, "sil_sendRawTransactionSync", hexutil.Bytes(rawTx), ms); err != nil {
		return nil, err
	}
	return &receipt, nil
}
...
// SimulateOptions represents the options for sil_simulateV1.
...
func (ec *Client) SimulateV1(ctx context.Context, opts SimulateOptions, blockNrOrHash *rpc.BlockNumberOrHash) ([]SimulateBlockResult, error) {
	...
	err := ec.c.CallContext(ctx, &result, "sil_simulateV1", opts, blockNrOrHash)
	return result, err
}
