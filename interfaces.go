...
// Package sila defines interfaces for interacting with Sila.
package sila
...
type SyncProgress struct {
	...
	// "fast sync" fields. These used to be sent by sila, but are no longer used
	// since version v1.10.
...
type FilterQuery struct {
	BlockHash *common.Hash     // used by sil_getLogs, return logs only from block with this hash
