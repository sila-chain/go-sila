	...
	check := func(shouldPanic bool, arg interface{}) {
		defer func() {
			...
			if shouldPanic && err == nil {
				t.Errorf("SilSubscribe should've panicked for %#v", arg)
			}
			if !shouldPanic && err != nil {
				t.Errorf("SilSubscribe shouldn't have panicked for %#v", arg)
		...
		client.SilSubscribe(context.Background(), arg, "foo_bar")
	}
	check(true, nil)
	check(true, 1)
...
// This test reproduces https://github.com/sila-chain/go-sila/issues/17837 where the
...
// not respond.
// It reproducers the issue https://github.com/sila-chain/go-sila/issues/30156
...
// It is the reproducer for https://github.com/sila-chain/go-sila/issues/22322
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("go-sila-test-ipc-%d-%d", os.Getpid(), rand.Int63())
