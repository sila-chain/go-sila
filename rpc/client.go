...
const (
	...
	subscribeTimeout   = 10 * time.Second // overall timeout sil_subscribe, rpc_modules calls
...
// SilSubscribe registers a subscription under the "sil" namespace.
func (c *Client) SilSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	return c.Subscribe(ctx, "sil", channel, args...)
}
