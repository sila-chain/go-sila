...
!define HELPURL "https://github.com/sila-chain/go-sila/issues"
!define UPDATEURL "https://github.com/sila-chain/go-sila/releases"
!define ABOUTURL "https://github.com/sila-chain/go-sila#sila-go"
...
# Install sila binary
Section "Sila" GSIL_IDX
  SetOutPath $INSTDIR
  file {{.Sila}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gsil.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gsil.exe" "attach"
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Sila incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gsil.exe" "" "" "Sila" 30303 "" "" ""
  SimpleFC::AdvAddRule "Sila outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gsil.exe" "" "" "Sila" "" 30303 "" ""
  SimpleFC::AdvAddRule "Sila UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gsil.exe" "" "" "Sila" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/sila-chain/SIPs/issues/147)
  ${EnvVarUpdate} $0 "SILA_SOCKET" "R" "HKLM" "\\.\pipe\gsil.ipc"
  ${EnvVarUpdate} $0 "SILA_SOCKET" "A" "HKLM" "\\.\pipe\gsil.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GSIL_IDX}
    SectionGetSize ${GSIL_IDX} $0
