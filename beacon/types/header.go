...
// https://github.com/sila-chain/consensus-specs/blob/dev/specs/phase0/beacon-chain.md#beaconblockheader
type Header struct {
	...
	// SSZ hash of the beacon state (https://github.com/sila-chain/consensus-specs/blob/dev/specs/bellatrix/beacon-chain.md#beacon-state)
	StateRoot common.Hash `gencodec:"required" json:"state_root"`

	// SSZ hash of the beacon block body (https://github.com/sila-chain/consensus-specs/blob/dev/specs/bellatrix/beacon-chain.md#beaconblockbody)
