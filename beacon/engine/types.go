...
var (
	...
	// PayloadV2 is the identifier of ExecutionPayloadV2 introduced in sila_shanghai fork.
	//
	// https://github.com/sila-chain/execution-apis/blob/main/src/engine/sila_shanghai.md#executionpayloadv2
	// ExecutionPayloadV2 has the syntax of ExecutionPayloadV1 and appends a
	// single field: withdrawals.
	PayloadV2 PayloadVersion = 0x2

	// PayloadV3 is the identifier of ExecutionPayloadV3 introduced in sila_cancun fork.
	//
	// https://github.com/sila-chain/execution-apis/blob/main/src/engine/sila_cancun.md#executionpayloadv3
...
func BlockToExecutableData(block *types.Block, fees *big.Int, sidecars []*types.BlobTxSidecar, requests [][]byte) *ExecutionPayloadEnvelope {
	...
	for _, sidecar := range sidecars {
		...
		// - Before the SilaOsaka fork, only version-0 blob transactions should be packed,
		//   with the proof length equal to len(blobs).
		//
		// - After the SilaOsaka fork, only version-1 blob transactions should be packed,
