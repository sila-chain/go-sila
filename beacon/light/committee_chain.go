...
func NewCommitteeChain(db sildb.KeyValueStore, config *params.ChainConfig, signerThreshold int, enforceTime bool) *CommitteeChain {
...
func NewTestCommitteeChain(db sildb.KeyValueStore, config *params.ChainConfig, signerThreshold int, enforceTime bool, clock *mclock.Simulated) *CommitteeChain {
...
func newCommitteeChain(db sildb.KeyValueStore, config *params.ChainConfig, signerThreshold int, enforceTime bool, sigVerifier committeeSigVerifier, clock mclock.Clock, unixNano func() int64) *CommitteeChain {
	s := &CommitteeChain{
...
func (s *CommitteeChain) deleteCommitteesFrom(batch sildb.Batch, period uint64) {
