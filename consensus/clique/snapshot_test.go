...
// mapped from textual names used in the tests below to actual Sila private
...
// address retrieves the Sila address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Sila address
	...
	tests := []cliqueTest{
		{
			...
			// batch (https://github.com/sila-chain/go-sila/issues/17593). Whilst this
