...
func loadSnapshot(config *params.CliqueConfig, sigcache *sigLRU, db sildb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db sildb.Database) error {
