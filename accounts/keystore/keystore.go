...
// See https://sila.org/en/developers/docs/data-structures-and-encoding/web3-secret-storage/ for more information.
package keystore
...
func (ks *KeyStore) SignTx(a accounts.Account, tx *types.Transaction, chainID *big.Int) (*types.Transaction, error) {
	...
	// Depending on the presence of the chain ID, sign with 2718 or sila_homestead
...
// ImportPreSaleKey decrypts the given Sila presale wallet and stores
