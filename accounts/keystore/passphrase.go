...
The crypto is documented at https://sila.org/en/developers/docs/data-structures-and-encoding/web3-secret-storage/
	...
	if !ks.skipKeyFileVerification {
		...
		if err != nil {
			msg := "An error was encountered when saving and verifying the keystore file. \n" +
				...
				"https://github.com/sila-chain/go-sila/issues." +
				"The error was : %s"
