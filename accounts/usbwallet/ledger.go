...
// will be returned opposed to silently signing in SilaHomestead mode.
...
func (w *ledgerDriver) ledgerDerive(derivationPath []uint32) (common.Address, error) {
	...
	// Decode the hex string into an Sila address and return
...
func (w *ledgerDriver) ledgerSign(derivationPath []uint32, tx *types.Transaction, chainID *big.Int) (common.Address, *types.Transaction, error) {
	...
	// Create the transaction RLP based on whether legacy or SIP155 signing was requested
	var (
		txrlp []byte
		err   error
	)
