...
import (
	...
	"github.com/sila-chain/go-sila/signer/core/apitypes"
)
...
func (api *ExternalSigner) SelfDerive(bases []accounts.DerivationPath, chain sila.ChainStateReader) {
...
func (api *ExternalSigner) SignText(account accounts.Account, text []byte) ([]byte, error) {
	...
	if signature[64] == 27 || signature[64] == 28 {
		...
		// the signature to sila-type signature.
		signature[64] -= 27 // Transform V from Sila-legacy to 0/1
	}
