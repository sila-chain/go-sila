...
import (
	...
	"github.com/sila-chain/go-sila/accounts/abi/bind/v2"
...
// C1 is an auto generated Go binding around an Sila contract.
type C1 struct {
	abi abi.ABI
}
...
// C2 is an auto generated Go binding around an Sila contract.
type C2 struct {
	abi abi.ABI
}
...
// L1 is an auto generated Go binding around an Sila contract.
type L1 struct {
	abi abi.ABI
}
...
// L2 is an auto generated Go binding around an Sila contract.
type L2 struct {
	abi abi.ABI
}
...
// L2b is an auto generated Go binding around an Sila contract.
type L2b struct {
	abi abi.ABI
}
...
// L3 is an auto generated Go binding around an Sila contract.
type L3 struct {
	abi abi.ABI
}
...
// L4 is an auto generated Go binding around an Sila contract.
type L4 struct {
	abi abi.ABI
}
...
// L4b is an auto generated Go binding around an Sila contract.
type L4b struct {
	abi abi.ABI
}
