...
import (
	...
	"github.com/sila-chain/go-sila/accounts/abi/bind/backends"
	"github.com/sila-chain/go-sila/accounts/abi/bind/v2"
	"github.com/sila-chain/go-sila/accounts/abi/bind/v2/internal/contracts/events"
	"github.com/sila-chain/go-sila/accounts/abi/bind/v2/internal/contracts/nested_libraries"
	"github.com/sila-chain/go-sila/accounts/abi/bind/v2/internal/contracts/solc_errors"
...
func testSetup() (*backends.SimulatedBackend, error) {
	backend := simulated.NewBackend(
		...
		func(nodeConf *node.Config, silConf *silconfig.Config) {
			silConf.Genesis.Difficulty = big.NewInt(0)
		},
	)
...
func TestErrors(t *testing.T) {
	...
	raw, hasRevertErrorData := silclient.RevertErrorData(err)
