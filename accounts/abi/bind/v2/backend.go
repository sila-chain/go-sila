...
type ContractCaller interface {
	...
	// CallContract executes an Sila contract call with the specified data as the
	// input.
...
type PendingContractCaller interface {
	...
	// PendingCallContract executes an Sila contract call against the pending state.
...
type BlockHashContractCaller interface {
	...
	// CallContractAtHash executes an Sila contract call against the state at the specified block hash.
