...
func TestEventTupleUnpack(t *testing.T) {
	...
	var testCases = []struct {
		...
		jsonEventTransfer,
		"",
		"Can unpack SRC20 Transfer event into structure",
	}, {
		transferData1,
		&[]interface{}{&bigint},
		...
		jsonEventTransfer,
		"",
		"Can unpack SRC20 Transfer event into slice",
	}, {
		transferData1,
		...
		jsonEventTransfer,
		"",
		"Can unpack SRC20 Transfer event into structure with abi: tag",
	}, {
		transferData1,
		...
		"Can not unpack SRC20 Transfer event with duplicated abi tag",
	}, {
		transferData1,
		...
		"Can not unpack SRC20 Transfer event with a field and a tag mapping to the same abi variable",
	}, {
		transferData1,
		...
		"Can not unpack SRC20 Transfer event with an empty tag",
	}, {
		pledgeData1,
		&EventPledge{},
		&EventPledge{
