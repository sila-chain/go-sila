...
import (
	...
	"github.com/sila-chain/go-sila/version"
)

const ourPath = "github.com/sila-chain/go-sila" // Path to our module
...
// Archive holds the textual version string used for Sila archives. e.g.
...
// conventions in the Sila p2p network.
...
//
// If the package that is currently executing is a prefixed by our go-sila
