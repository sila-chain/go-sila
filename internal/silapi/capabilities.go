...
import (
	...
	corestate "github.com/sila-chain/go-sila/core/state"
)
...
// buildCapabilities computes the sil_capabilities response from the head
...
func buildCapabilities(headNum uint64, headHash common.Hash, cutoff uint64, ret HistoryRetention) *Capabilities {
	...
	// sila: they are either kept in full ("all") or pruned to a fixed
	...
	// sil_getProof availability tracks state availability in hash mode and
