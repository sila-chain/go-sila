...
var (
	...
	silashChainConfig *params.ChainConfig
...
func init() {
	...
	silashChainConfig = new(params.ChainConfig)
	*silashChainConfig = *params.TestChainConfig
...
func newTestWorkerBackend(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, db sildb.Database, n int) *testWorkerBackend {
...
func newTestWorker(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, db sildb.Database, blocks int) (*Miner, *testWorkerBackend) {
...
func TestBuildPayload(t *testing.T) {
	...
	w, b := newTestWorker(t, params.TestChainConfig, silash.NewFaker(), db, 0)
...
// the first Amsterdam block contains the SIP-7997 deterministic deployment
...
func TestBuildPayloadAmsterdamTransition(t *testing.T) {
	...
	*config.AmsterdamTime = 1 // genesis (t=0) is pre-Amsterdam, the first block crosses the fork
	...
	// The block must be importable: Process applies SIP-7997 independently, so
