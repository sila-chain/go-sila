...
// https://github.com/sila-chain/execution-apis/blob/main/src/engine/sila_cancun.md#payloadattributesv3
...
func (miner *Miner) buildPayload(ctx context.Context, args *BuildPayloadArgs, witness bool) (result *Payload, err error) {
	...
	go func() {
		...
		// the SilaMainnet configuration) have passed since the point in time identified
