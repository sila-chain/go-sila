...
type generateParams struct {
	...
	withdrawals types.Withdrawals // List of withdrawals to include in block (sila_shanghai field)
	beaconRoot  *common.Hash      // The beacon root (sila_cancun field).
...
func (miner *Miner) generateWork(ctx context.Context, genParam *generateParams, witness bool) (result *newPayloadResult) {
	...
	if !miner.chainConfig.IsSilaShanghai(work.header.Number, work.header.Time) {
		if body.Withdrawals != nil {
			return &newPayloadResult{err: errors.New("unexpected withdrawals before sila_shanghai")}
		}
	} else {
		if body.Withdrawals == nil {
