...
This is a post-mortem concerning the minority split that occurred on Sila mainnet on block [13107518](https://etherscan.io/block/13107518), at which a minority chain split occurred.
...
- 2021-08-24: Released [v1.10.8](https://github.com/sila-chain/go-sila/releases/tag/v1.10.8) containing the fix on Tuesday morning (CET). Erigon released [v2021.08.04](https://github.com/ledgerwatch/erigon/releases/tag/v2021.08.04).
...
- [1] https://twitter.com/go_sila/status/1428051458763763721
...
```
We have identified a security issue with go-sila, and will issue a
...
upgrade to the latest go-sila codebase. More information about the
issue will be disclosed at a later date.

https://twitter.com/go_sila/status/1428051458763763721
