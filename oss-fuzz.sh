...
coverpkg="github.com/sila-chain/go-sila/..."
...
repo=$GOPATH/src/github.com/sila-chain/go-sila
compile_fuzzer github.com/sila-chain/go-sila/accounts/abi \
  FuzzABI fuzzAbi \
  $repo/accounts/abi/abifuzzer_test.go

compile_fuzzer github.com/sila-chain/go-sila/common/bitutil \
...
compile_fuzzer github.com/sila-chain/go-sila/core/vm/runtime \
  FuzzVmRuntime fuzzVmRuntime\
  $repo/core/vm/runtime/runtime_fuzz_test.go

compile_fuzzer github.com/sila-chain/go-sila/core/vm \
  FuzzPrecompiledContracts fuzzPrecompiledContracts\
  $repo/core/vm/contracts_fuzz_test.go,$repo/core/vm/contracts_test.go

compile_fuzzer github.com/sila-chain/go-sila/core/types \
  FuzzRLP fuzzRlp \
  $repo/core/types/rlp_fuzzer_test.go

compile_fuzzer github.com/sila-chain/go-sila/crypto/blake2b \
  Fuzz fuzzBlake2b \
  $repo/crypto/blake2b/blake2b_f_fuzz_test.go

compile_fuzzer github.com/sila-chain/go-sila/accounts/keystore \
  FuzzPassword fuzzKeystore \
  $repo/accounts/keystore/keystore_fuzzing_test.go

pkg=$repo/trie/
compile_fuzzer github.com/sila-chain/go-sila/trie \
  FuzzTrie fuzzTrie \
...
compile_fuzzer github.com/sila-chain/go-sila/sil/protocols/snap \
  FuzzARange fuzz_account_range \
  $repo/sil/protocols/snap/handler_fuzzing_test.go
...
compile_fuzzer github.com/sila-chain/go-sila/tests/fuzzers/bn256 \
...
compile_fuzzer github.com/sila-chain/go-sila/tests/fuzzers/txfetcher \
  Fuzz fuzzTxfetcher \
  $repo/tests/fuzzers/txfetcher/txfetcher_test.go

compile_fuzzer github.com/sila-chain/go-sila/tests/fuzzers/bls12381 \
...
compile_fuzzer github.com/sila-chain/go-sila/tests/fuzzers/secp256k1 \
  Fuzz fuzzSecp256k1\
