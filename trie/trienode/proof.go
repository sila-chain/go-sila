...
func (db *ProofSet) Store(target sildb.KeyValueWriter) {
	db.lock.RLock()
	defer db.lock.RUnlock()
...
// ProofList stores an ordered list of trie nodes. It implements sildb.KeyValueWriter.
type ProofList []rlp.RawValue

// Store writes the contents of the list to the given database
func (n ProofList) Store(db sildb.KeyValueWriter) {
	for _, node := range n {
