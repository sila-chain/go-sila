...
func (s *spongeDb) NewBatch() sildb.Batch                    { return &spongeBatch{s} }
func (s *spongeDb) NewBatchWithSize(size int) sildb.Batch    { return &spongeBatch{s} }
...
func (s *spongeDb) NewIterator(prefix []byte, start []byte) sildb.Iterator { panic("implement me") }
...
func (b *spongeBatch) Replay(w sildb.KeyValueWriter) error { return nil }
...
// goos: darwin
// goarch: arm64
// pkg: github.com/sila-chain/go-sila/trie
// cpu: Apple M1 Pro
