...
import (
	...
	"github.com/sila-chain/go-sila/sildb/leveldb"
...
func openDatabase(o internalOpenOptions) (sildb.Database, error) {
...
func openKeyValueDatabase(o internalOpenOptions) (sildb.KeyValueStore, error) {
...
func newLevelDBDatabase(file string, cache int, handles int, namespace string, readonly bool) (sildb.KeyValueStore, error) {
...
func newPebbleDBDatabase(file string, cache int, handles int, namespace string, readonly bool) (sildb.KeyValueStore, error) {
