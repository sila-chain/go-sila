...
const (
	...
	MaxTxGas uint64 = 1 << 24 // Maximum transaction gas limit after sip-7825 (16,777,216).
	...
	CreateNGasSip4762     uint64 = 1000  // Once per CREATEn operations post-verkle
	...
	TxAccessListAddressGas    uint64 = 2400  // Per address specified in SIP 2930 access list
	TxAccessListStorageKeyGas uint64 = 1900  // Per storage key specified in SIP 2930 access list
	TxAuthTupleGas            uint64 = 12500 // Per auth tuple code specified in SIP-7702

	RegularPerAuthBaseCost uint64 = 7816 // As defined by SIP-8037 and SIP-8038
	...
	// SIP-8038: state-access gas cost update (Amsterdam).
	...
	ExpByteSIP158   uint64 = 50 // was raised to 50 during Sip158 (Spurious Dragon)
	...
	// Introduced in Tangerine Whistle (Sip 150)
	...
	Bn256AddGasSilaByzantium             uint64 = 500    // SilaByzantium gas needed for an elliptic curve addition
	Bn256AddGasSilaIstanbul              uint64 = 150    // Gas needed for an elliptic curve addition
	Bn256ScalarMulGasSilaByzantium       uint64 = 40000  // SilaByzantium gas needed for an elliptic curve scalar multiplication
	Bn256ScalarMulGasSilaIstanbul        uint64 = 6000   // Gas needed for an elliptic curve scalar multiplication
	Bn256PairingBaseGasSilaByzantium     uint64 = 100000 // SilaByzantium base price for an elliptic curve pairing check
	Bn256PairingBaseGasSilaIstanbul      uint64 = 45000  // Base price for an elliptic curve pairing check
	Bn256PairingPerPointGasSilaByzantium uint64 = 80000  // SilaByzantium per-point price for an elliptic curve pairing check
	Bn256PairingPerPointGasSilaIstanbul  uint64 = 34000  // Per-point price for an elliptic curve pairing check
	...
	HistoryServeWindow = 8191 // Number of blocks to serve historical block hashes for, SIP-2935.

	MaxBlockSize = 8_388_608 // maximum size of an RLP-encoded block

	// BALItemCost is the gas-cost divisor for the SIP-7928 block access list
...
// System contracts.
var (
	// SystemAddress is where the system-transaction is sent from as per SIP-4788
	...
	// SIP-2935 - Serve historical block hashes from state
	...
	// SIP-7002 - Execution layer triggerable withdrawals
	...
	// SIP-7251 - Increase the MAX_EFFECTIVE_BALANCE
	...
	// SIP-7997 - Deterministic deployment factory (keyless CREATE2 factory)
...
// System log events.
var (
	// SIP-7708 - System logs emitted for SIL transfer and burn
	SilTransferLogEvent = common.HexToHash("0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef") // keccak256('Transfer(address,address,uint256)')
	SilBurnLogEvent     = common.HexToHash("0xcc16f5dbb4873280815c1ee09dbd06736cffcc184412cf7a71a0fdb75d397ca5") // keccak256('Burn(address,uint256)')
