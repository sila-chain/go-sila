...
import (
	...
	"github.com/sila-chain/go-sila/core/rawdb/eradb"
...
type chainFreezer struct {
	ancients sildb.AncientStore // Ancient store for storing cold chain segment
...
func (f *chainFreezer) readHeadNumber(db sildb.KeyValueReader) uint64 {
...
func (f *chainFreezer) readFinalizedNumber(db sildb.KeyValueReader) uint64 {
...
func (f *chainFreezer) freezeThreshold(db sildb.KeyValueReader) (uint64, error) {
	var (
...
func (f *chainFreezer) freeze(db sildb.KeyValueStore) {
	var (
		backoff   bool
...
func (f *chainFreezer) freezeRange(nfdb *nofreezedb, number, limit uint64) (hashes []common.Hash, err error) {
	...
	_, err = f.ModifyAncients(func(op sildb.AncientWriteOp) error {
...
func (f *chainFreezer) ReadAncients(fn func(sildb.AncientReaderOp) error) (err error) {
...
func (f *chainFreezer) ModifyAncients(fn func(sildb.AncientWriteOp) error) (int64, error) {
