...
func ReadAccountTrieNode(db sildb.KeyValueReader, path []byte) []byte {
...
func HasAccountTrieNode(db sildb.KeyValueReader, path []byte) bool {
...
func WriteAccountTrieNode(db sildb.KeyValueWriter, path []byte, node []byte) {
...
func DeleteAccountTrieNode(db sildb.KeyValueWriter, path []byte) {
...
func ReadStorageTrieNode(db sildb.KeyValueReader, accountHash common.Hash, path []byte) []byte {
...
func HasStorageTrieNode(db sildb.KeyValueReader, accountHash common.Hash, path []byte) bool {
...
func WriteStorageTrieNode(db sildb.KeyValueWriter, accountHash common.Hash, path []byte, node []byte) {
...
func DeleteStorageTrieNode(db sildb.KeyValueWriter, accountHash common.Hash, path []byte) {
...
func ReadLegacyTrieNode(db sildb.KeyValueReader, hash common.Hash) []byte {
...
func HasLegacyTrieNode(db sildb.KeyValueReader, hash common.Hash) bool {
	ok, _ := db.Has(hash.Bytes())
	return ok
}

// WriteLegacyTrieNode writes the provided legacy trie node to database.
func WriteLegacyTrieNode(db sildb.KeyValueWriter, hash common.Hash, node []byte) {
...
func DeleteLegacyTrieNode(db sildb.KeyValueWriter, hash common.Hash) {
...
func HasTrieNode(db sildb.KeyValueReader, owner common.Hash, path []byte, hash common.Hash, scheme string) bool {
	switch scheme {
	case HashScheme:
...
func ReadTrieNode(db sildb.KeyValueReader, owner common.Hash, path []byte, hash common.Hash, scheme string) []byte {
	switch scheme {
	case HashScheme:
...
func WriteTrieNode(db sildb.KeyValueWriter, owner common.Hash, path []byte, hash common.Hash, node []byte, scheme string) {
	switch scheme {
	case HashScheme:
...
// hash-scheme requires the node hash as the identifier.
// path-scheme requires the node owner and path as the identifier.
func DeleteTrieNode(db sildb.KeyValueWriter, owner common.Hash, path []byte, hash common.Hash, scheme string) {
	switch scheme {
	case HashScheme:
...
func ReadStateScheme(db sildb.Database) string {
...
//     compatible with persistent state scheme.
func ParseStateScheme(provided string, disk sildb.Database) (string, error) {
