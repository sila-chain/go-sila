// Copyright 2018 The go-sila Authors
...
func ReadCanonicalHash(db sildb.Reader, number uint64) common.Hash {
	var data []byte
...
func WriteCanonicalHash(db sildb.KeyValueWriter, hash common.Hash, number uint64) {
...
func DeleteCanonicalHash(db sildb.KeyValueWriter, number uint64) {
...
func ReadAllHashes(db sildb.Iteratee, number uint64) []common.Hash {
...
func ReadHeaderNumber(db sildb.KeyValueReader, hash common.Hash) (uint64, bool) {
...
func WriteHeaderNumber(db sildb.KeyValueWriter, hash common.Hash, number uint64) {
...
func DeleteHeaderNumber(db sildb.KeyValueWriter, hash common.Hash) {
...
func ReadHeadHeaderHash(db sildb.KeyValueReader) common.Hash {
...
func WriteHeadHeaderHash(db sildb.KeyValueWriter, hash common.Hash) {
...
func ReadHeadBlockHash(db sildb.KeyValueReader) common.Hash {
...
func WriteHeadBlockHash(db sildb.KeyValueWriter, hash common.Hash) {
...
func ReadHeadFastBlockHash(db sildb.KeyValueReader) common.Hash {
...
func WriteHeadFastBlockHash(db sildb.KeyValueWriter, hash common.Hash) {
...
func ReadFinalizedBlockHash(db sildb.KeyValueReader) common.Hash {
...
func WriteFinalizedBlockHash(db sildb.KeyValueWriter, hash common.Hash) {
...
func WriteLastPivotNumber(db sildb.KeyValueWriter, pivot uint64) {
...
func ReadTxIndexTail(db sildb.KeyValueReader) *uint64 {
...
// into database.
func WriteTxIndexTail(db sildb.KeyValueWriter, number uint64) {
...
// from database.
func DeleteTxIndexTail(db sildb.KeyValueWriter) {
...
func ReadHeaderRange(db sildb.Reader, number uint64, count uint64) []rlp.RawValue {
...
func ReadHeaderRLP(db sildb.Reader, hash common.Hash, number uint64) rlp.RawValue {
	var data []byte
	db.ReadAncients(func(reader sildb.AncientReaderOp) error {
...
func HasHeader(db sildb.Reader, hash common.Hash, number uint64) bool {
...
func ReadHeader(db sildb.Reader, hash common.Hash, number uint64) *types.Header {
...
// to-number mapping.
func WriteHeader(db sildb.KeyValueWriter, header *types.Header) {
	var (
		hash   = header.Hash()
...
func DeleteHeader(db sildb.KeyValueWriter, hash common.Hash, number uint64) {
...
func deleteHeaderWithoutNumber(db sildb.KeyValueWriter, hash common.Hash, number uint64) {
...
func isCanon(reader sildb.AncientReaderOp, number uint64, hash common.Hash) bool {
...
func ReadBodyRLP(db sildb.Reader, hash common.Hash, number uint64) rlp.RawValue {
	// First try to look up the data in ancient database. Extra hash
	// comparison is necessary since ancient database only maintains
	// the canonical data.
	var data []byte
...
func ReadCanonicalBodyRLP(db sildb.Reader, number uint64, hash *common.Hash) rlp.RawValue {
	var data []byte
	db.ReadAncients(func(reader sildb.AncientReaderOp) error {
		data, _ = reader.Ancient(ChainFreezerBodiesTable, number)
		if len(data) > 0 {
...
func WriteBodyRLP(db sildb.KeyValueWriter, hash common.Hash, number uint64, rlp rlp.RawValue) {
...
func HasBody(db sildb.Reader, hash common.Hash, number uint64) bool {
	if isCanon(db, number, hash) {
		return true
	}
...
func ReadBody(db sildb.Reader, hash common.Hash, number uint64) *types.Body {
...
func WriteBody(db sildb.KeyValueWriter, hash common.Hash, number uint64, body *types.Body) {
...
func DeleteBody(db sildb.KeyValueWriter, hash common.Hash, number uint64) {
...
func HasAccessList(db sildb.Reader, hash common.Hash, number uint64) bool {
	has, _ := db.Has(accessListKey(number, hash))
	return has
}

// ReadAccessListRLP retrieves the RLP-encoded block access list for a block.
func ReadAccessListRLP(db sildb.Reader, hash common.Hash, number uint64) rlp.RawValue {
	var data []byte
	db.ReadAncients(func(reader sildb.AncientReaderOp) error {
...
func ReadAccessList(db sildb.Reader, hash common.Hash, number uint64) *bal.BlockAccessList {
...
func WriteAccessList(db sildb.KeyValueWriter, hash common.Hash, number uint64, b *bal.BlockAccessList) {
...
func WriteAccessListRLP(db sildb.KeyValueWriter, hash common.Hash, number uint64, encoded rlp.RawValue) {
...
func DeleteAccessList(db sildb.KeyValueWriter, hash common.Hash, number uint64) {
...
func ReadBlock(db sildb.Reader, hash common.Hash, number uint64) *types.Block {
	header := ReadHeader(db, hash, number)
	if header == nil {
		return nil
	}
...
func WriteBlock(db sildb.KeyValueWriter, block *types.Block) {
...
type ExecutionDetail struct {
	// AccessList is the SIP-7928 block-level access list attached to the block.
...
func readBadBlocks(db sildb.Reader) []*badBlock {
...
func ReadBadBlock(db sildb.Reader, hash common.Hash) *types.Block {
...
func ReadAllBadBlocks(db sildb.Reader) []*types.Block {
...
func ReadAllBadBlocksWithDetails(db sildb.Reader) ([]*types.Block, []*ExecutionDetail) {
	var (
		blocks  []*types.Block
...
func ReadBadBlockWithDetails(db sildb.Reader, hash common.Hash) *BadBlockDetails {
	for _, bad := range readBadBlocks(db) {
		if bad.Header.Hash() == hash {
			detail := bad.Detail
			if detail == nil {
...
func WriteBadBlock(db sildb.KeyValueStore, block *types.Block) {
...
// none.
func WriteBadBlockWithDetails(db sildb.KeyValueStore, block *types.Block, detail *ExecutionDetail) {
	blob, err := db.Get(badBlockKey)
	if err != nil {
...
func ReadHeadHeader(db sildb.Reader) *types.Header {
...
func ReadHeadBlock(db sildb.Reader) *types.Block {
