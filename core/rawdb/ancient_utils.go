...
func inspect(name string, order map[string]freezerTableConfig, reader sildb.AncientReader) (freezerInfo, error) {
...
func inspectFreezers(db sildb.Database) ([]freezerInfo, error) {
