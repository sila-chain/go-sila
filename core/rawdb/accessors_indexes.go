...
func DecodeTxLookupEntry(data []byte, db sildb.Reader) *uint64 {
...
func ReadTxLookupEntry(db sildb.Reader, hash common.Hash) *uint64 {
...
func writeTxLookupEntry(db sildb.KeyValueWriter, hash common.Hash, numberBytes []byte) {
...
// a list of hashes
func WriteTxLookupEntries(db sildb.KeyValueWriter, number uint64, hashes []common.Hash) {
...
func WriteTxLookupEntriesByBlock(db sildb.KeyValueWriter, block *types.Block) {
...
func DeleteTxLookupEntry(db sildb.KeyValueWriter, hash common.Hash) {
...
func DeleteTxLookupEntries(db sildb.KeyValueWriter, hashes []common.Hash) {
	for _, hash := range hashes {
...
func DeleteAllTxLookupEntries(db sildb.KeyValueStore, condition func(common.Hash, []byte) bool) {
...
// chain is visible.
func ReadCanonicalTransaction(db sildb.Reader, hash common.Hash) (*types.Transaction, common.Hash, uint64, uint64) {
...
// chain is visible.
func ReadCanonicalReceipt(db sildb.Reader, hash common.Hash, config *params.ChainConfig) (*types.Receipt, common.Hash, uint64, uint64) {
...
func ReadCanonicalRawReceipt(db sildb.Reader, blockHash common.Hash, blockNumber, txIndex uint64) (*types.Receipt, RawReceiptContext, error) {
...
func ReadFilterMapExtRow(db sildb.KeyValueReader, mapRowIndex uint64, bitLength uint) ([]uint32, error) {
...
func ReadFilterMapBaseRows(db sildb.KeyValueReader, mapRowIndex uint64, rowCount uint32, bitLength uint) ([][]uint32, error) {
	byteLength := int(bitLength) / 8
	if int(bitLength) != byteLength*8 {
		panic("invalid bit length")
	}
...
func WriteFilterMapExtRow(db sildb.KeyValueWriter, mapRowIndex uint64, row []uint32, bitLength uint) {
	byteLength := int(bitLength) / 8
	if int(bitLength) != byteLength*8 {
		panic("invalid bit length")
	}
...
func WriteFilterMapBaseRows(db sildb.KeyValueWriter, mapRowIndex uint64, rows [][]uint32, bitLength uint) {
	byteLength := int(bitLength) / 8
	if int(bitLength) != byteLength*8 {
		panic("invalid bit length")
	}
...
func DeleteFilterMapRows(db sildb.KeyValueStore, mapRows common.Range[uint64], hashScheme bool, stopCallback func(bool) bool) error {
...
func ReadFilterMapLastBlock(db sildb.KeyValueReader, mapIndex uint32) (uint64, common.Hash, error) {
...
// last log value entry of the given map.
func WriteFilterMapLastBlock(db sildb.KeyValueWriter, mapIndex uint32, blockNumber uint64, id common.Hash) {
	var enc [40]byte
...
// last log value entry of the given map.
func DeleteFilterMapLastBlock(db sildb.KeyValueWriter, mapIndex uint32) {
	if err := db.Delete(filterMapLastBlockKey(mapIndex)); err != nil {
		log.Crit("Failed to delete filter map last block pointer", "err", err)
	}
}

func DeleteFilterMapLastBlocks(db sildb.KeyValueStore, maps common.Range[uint32], hashScheme bool, stopCallback func(bool) bool) error {
...
func ReadBlockLvPointer(db sildb.KeyValueReader, blockNumber uint64) (uint64, error) {
...
// generated by the given block are located.
func WriteBlockLvPointer(db sildb.KeyValueWriter, blockNumber, lvPointer uint64) {
	var encPtr [8]byte
...
// generated by the given block are located.
func DeleteBlockLvPointer(db sildb.KeyValueWriter, blockNumber uint64) {
	if err := db.Delete(filterMapBlockLVKey(blockNumber)); err != nil {
		log.Crit("Failed to delete block log value pointer", "err", err)
	}
}

func DeleteBlockLvPointers(db sildb.KeyValueStore, blocks common.Range[uint64], hashScheme bool, stopCallback func(bool) bool) error {
...
func ReadFilterMapsRange(db sildb.KeyValueReader) (FilterMapsRange, bool, error) {
...
func WriteFilterMapsRange(db sildb.KeyValueWriter, fmRange FilterMapsRange) {
...
func DeleteFilterMapsRange(db sildb.KeyValueWriter) {
...
func deletePrefixRange(db sildb.KeyValueStore, prefix []byte, hashScheme bool, stopCallback func(bool) bool) error {
...
func DeleteFilterMapsDb(db sildb.KeyValueStore, hashScheme bool, stopCallback func(bool) bool) error {
...
func DeleteBloomBitsDb(db sildb.KeyValueStore, hashScheme bool, stopCallback func(bool) bool) error {
