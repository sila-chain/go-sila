...
func ReadStateHistoryIndexMetadata(db sildb.KeyValueReader) []byte {
...
// into database.
func WriteStateHistoryIndexMetadata(db sildb.KeyValueWriter, blob []byte) {
...
func DeleteStateHistoryIndexMetadata(db sildb.KeyValueWriter) {
...
func ReadTrienodeHistoryIndexMetadata(db sildb.KeyValueReader) []byte {
...
// into database.
func WriteTrienodeHistoryIndexMetadata(db sildb.KeyValueWriter, blob []byte) {
...
func DeleteTrienodeHistoryIndexMetadata(db sildb.KeyValueWriter) {
...
// account address.
func ReadAccountHistoryIndex(db sildb.KeyValueReader, addressHash common.Hash) []byte {
...
func WriteAccountHistoryIndex(db sildb.KeyValueWriter, addressHash common.Hash, data []byte) {
...
// the database.
func DeleteAccountHistoryIndex(db sildb.KeyValueWriter, addressHash common.Hash) {
...
func ReadStorageHistoryIndex(db sildb.KeyValueReader, addressHash common.Hash, storageHash common.Hash) []byte {
...
func WriteStorageHistoryIndex(db sildb.KeyValueWriter, addressHash common.Hash, storageHash common.Hash, data []byte) {
...
func DeleteStorageHistoryIndex(db sildb.KeyValueWriter, addressHash common.Hash, storageHash common.Hash) {
...
// account address and storage key hash.
func ReadTrienodeHistoryIndex(db sildb.KeyValueReader, addressHash common.Hash, path []byte) []byte {
...
func WriteTrienodeHistoryIndex(db sildb.KeyValueWriter, addressHash common.Hash, path []byte, data []byte) {
...
func DeleteTrienodeHistoryIndex(db sildb.KeyValueWriter, addressHash common.Hash, path []byte) {
...
func ReadAccountHistoryIndexBlock(db sildb.KeyValueReader, addressHash common.Hash, blockID uint32) []byte {
...
func WriteAccountHistoryIndexBlock(db sildb.KeyValueWriter, addressHash common.Hash, blockID uint32, data []byte) {
...
func DeleteAccountHistoryIndexBlock(db sildb.KeyValueWriter, addressHash common.Hash, blockID uint32) {
...
func ReadStorageHistoryIndexBlock(db sildb.KeyValueReader, addressHash common.Hash, storageHash common.Hash, blockID uint32) []byte {
...
func WriteStorageHistoryIndexBlock(db sildb.KeyValueWriter, addressHash common.Hash, storageHash common.Hash, id uint32, data []byte) {
...
func DeleteStorageHistoryIndexBlock(db sildb.KeyValueWriter, addressHash common.Hash, storageHash common.Hash, id uint32) {
...
// identifier along with the block id.
func ReadTrienodeHistoryIndexBlock(db sildb.KeyValueReader, addressHash common.Hash, path []byte, blockID uint32) []byte {
...
func WriteTrienodeHistoryIndexBlock(db sildb.KeyValueWriter, addressHash common.Hash, path []byte, id uint32, data []byte) {
...
func DeleteTrienodeHistoryIndexBlock(db sildb.KeyValueWriter, addressHash common.Hash, path []byte, id uint32) {
...
func DeleteStateHistoryIndexes(db sildb.KeyValueRangeDeleter) {
...
func DeleteTrienodeHistoryIndexes(db sildb.KeyValueRangeDeleter) {
...
func DeleteHistoryByRange(db sildb.KeyValueRangeDeleter, prefix []byte) {
	start := prefix
	...
	for {
		...
		if errors.Is(err, sildb.ErrTooManyKeys) {
			continue
		}
