...
func ReadSnapshotDisabled(db sildb.KeyValueReader) bool {
	disabled, _ := db.Has(snapshotDisabledKey)
	return disabled
}

// WriteSnapshotDisabled stores the snapshot pause flag.
func WriteSnapshotDisabled(db sildb.KeyValueWriter) {
...
func DeleteSnapshotDisabled(db sildb.KeyValueWriter) {
...
func ReadSnapshotRoot(db sildb.KeyValueReader) common.Hash {
...
// the persisted snapshot.
func WriteSnapshotRoot(db sildb.KeyValueWriter, root common.Hash) {
...
// invalid.
func DeleteSnapshotRoot(db sildb.KeyValueWriter) {
...
func ReadAccountSnapshot(db sildb.KeyValueReader, hash common.Hash) []byte {
	data, _ := db.Get(accountSnapshotKey(hash))
	return data
}

// WriteAccountSnapshot stores the snapshot entry of an account trie leaf.
func WriteAccountSnapshot(db sildb.KeyValueWriter, hash common.Hash, entry []byte) {
...
func DeleteAccountSnapshot(db sildb.KeyValueWriter, hash common.Hash) {
...
func ReadStorageSnapshot(db sildb.KeyValueReader, accountHash, storageHash common.Hash) []byte {
	data, _ := db.Get(storageSnapshotKey(accountHash, storageHash))
	return data
}

// WriteStorageSnapshot stores the snapshot entry of a storage trie leaf.
func WriteStorageSnapshot(db sildb.KeyValueWriter, accountHash, storageHash common.Hash, entry []byte) {
...
func DeleteStorageSnapshot(db sildb.KeyValueWriter, accountHash, storageHash common.Hash) {
...
func IterateStorageSnapshots(db sildb.Iteratee, accountHash common.Hash) sildb.Iterator {
...
func ReadSnapshotJournal(db sildb.KeyValueReader) []byte {
...
func WriteSnapshotJournal(db sildb.KeyValueWriter, journal []byte) {
...
// the last shutdown
func DeleteSnapshotJournal(db sildb.KeyValueWriter) {
...
// the last shutdown.
func ReadSnapshotGenerator(db sildb.KeyValueReader) []byte {
...
// shutdown.
func WriteSnapshotGenerator(db sildb.KeyValueWriter, generator []byte) {
...
// the last shutdown
func DeleteSnapshotGenerator(db sildb.KeyValueWriter) {
...
// snapshot layer.
func ReadSnapshotRecoveryNumber(db sildb.KeyValueReader) *uint64 {
...
// snapshot layer.
func WriteSnapshotRecoveryNumber(db sildb.KeyValueWriter, number uint64) {
	var buf [8]byte
...
// snapshot layer.
func DeleteSnapshotRecoveryNumber(db sildb.KeyValueWriter) {
...
func ReadSnapshotSyncStatus(db sildb.KeyValueReader) []byte {
	data, _ := db.Get(snapshotSyncStatusKey)
	return data
}

// WriteSnapshotSyncStatus stores the serialized sync status to save at shutdown.
func WriteSnapshotSyncStatus(db sildb.KeyValueWriter, status []byte) {
...
func DeleteSnapshotSyncStatus(db sildb.KeyValueWriter) {
