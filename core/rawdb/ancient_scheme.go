...
//     state freezer.
func NewStateFreezer(ancientDir string, verkle bool, readOnly bool) (sildb.ResettableAncientStore, error) {
	if ancientDir == "" {
	...
	return newResettableFreezer(name, "sil/db/state", readOnly, stateHistoryTableSize, stateFreezerTableConfigs)
}
...
//   - if non-empty directory is given, initializes the regular file-based
//     trienode freezer.
func NewTrienodeFreezer(ancientDir string, verkle bool, readOnly bool) (sildb.ResettableAncientStore, error) {
	if ancientDir == "" {
	...
	return newResettableFreezer(name, "sil/db/trienode", readOnly, stateHistoryTableSize, trienodeFreezerTableConfigs)
}
