...
func InitDatabaseFromFreezer(db sildb.Database) {
...
func iterateTransactions(db sildb.Database, from uint64, to uint64, reverse bool, interrupt chan struct{}) chan *blockTxHashes {
...
// signal received.
func indexTransactions(db sildb.Database, from uint64, to uint64, interrupt chan struct{}, hook func(uint64) bool, report bool) {
...
// There is a passed channel, the whole procedure will be interrupted if any
// signal received.
func IndexTransactions(db sildb.Database, from uint64, to uint64, interrupt chan struct{}, report bool) {
...
func indexTransactionsForTesting(db sildb.Database, from uint64, to uint64, interrupt chan struct{}, hook func(uint64) bool) {
...
// There is a passed channel, the whole procedure will be interrupted if any
// signal received.
func unindexTransactions(db sildb.Database, from uint64, to uint64, interrupt chan struct{}, hook func(uint64) bool, report bool) {
	// short circuit for invalid range
	if from >= to {
		return
	}
...
// There is a passed channel, the whole procedure will be interrupted if any
// signal received.
func UnindexTransactions(db sildb.Database, from uint64, to uint64, interrupt chan struct{}, report bool) {
...
func unindexTransactionsForTesting(db sildb.Database, from uint64, to uint64, interrupt chan struct{}, hook func(uint64) bool) {
...
func PruneTransactionIndex(db sildb.Database, pruneBlock uint64) {
