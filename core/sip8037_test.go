...
// runtime (SIP-2780), not intrinsically.
...
// An account can exist yet be SIP-161-empty in the middle of a transaction,
...
func TestCreate2TransientEmptyDestNoRefill(t *testing.T) {
	...
	// leaving it existing but SIP-161-empty for the rest of the transaction.
...
// latter carrying a single storage slot while remaining SIP-161-empty.
...
// The SIP-7623/7976 calldata floor is capped by MaxTxGas even when the gas
...
// the state-dependent charges are applied at runtime (SIP-2780).
