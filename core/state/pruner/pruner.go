...
func NewPruner(db sildb.Database, config Config) (*Pruner, error) {
...
func prune(snaptree *snapshot.Tree, root common.Hash, maindb sildb.Database, stateBloom *stateBloom, bloomPath string, middleStateRoots map[common.Hash]struct{}, start time.Time) error {
...
// in the disk.
func RecoverPruning(datadir string, db sildb.Database) error {
...
func extractGenesis(db sildb.Database, stateBloom *stateBloom) error {
