...
func loadAndParseJournal(db sildb.KeyValueStore, base *diskLayer) (snapshot, journalGenerator, error) {
...
func loadSnapshot(diskdb sildb.KeyValueStore, triedb *triedb.Database, root common.Hash, cache int, recovery bool, noBuild bool) (snapshot, bool, error) {
...
func iterateJournal(db sildb.KeyValueReader, callback journalCallback) error {
