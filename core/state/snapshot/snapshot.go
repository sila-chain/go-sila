...
// Tree is an Sila state snapshot tree. It consists of one persistent base
...
type Tree struct {
	...
	diskdb sildb.KeyValueStore      // Persistent database to store the snapshot
...
//     a background thread.
func New(config Config, diskdb sildb.KeyValueStore, triedb *triedb.Database, root common.Hash) (*Tree, error) {
...
func (t *Tree) Verify(root common.Hash) error {
	...
	got, err := generateTrieRoot(nil, "", acctIt, common.Hash{}, stackTrieGenerate, func(db sildb.KeyValueWriter, accountHash, codeHash common.Hash, stat *generateStats) (common.Hash, error) {
