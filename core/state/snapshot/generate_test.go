...
func checkSnapRoot(t *testing.T, snap *diskLayer, trieRoot common.Hash) {
	...
	snapRoot, err := generateTrieRoot(nil, "", accIt, common.Hash{}, stackTrieGenerate,
		func(db sildb.KeyValueWriter, accountHash, codeHash common.Hash, stat *generateStats) (common.Hash, error) {
...
func populateDangling(disk sildb.KeyValueStore) {
