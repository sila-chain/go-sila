...
type (
	...
	trieGeneratorFn func(db sildb.KeyValueWriter, scheme string, owner common.Hash, in chan (trieKV), out chan (common.Hash))

	// leafCallbackFn is the callback invoked at the leaves of the trie,
	// returns the subtrie root with the specified subtrie identifier.
	leafCallbackFn func(db sildb.KeyValueWriter, accountHash, codeHash common.Hash, stat *generateStats) (common.Hash, error)
)
...
func GenerateTrie(snaptree *Tree, root common.Hash, src sildb.Database, dst sildb.KeyValueWriter) error {
	...
	got, err := generateTrieRoot(dst, scheme, acctIt, common.Hash{}, stackTrieGenerate, func(dst sildb.KeyValueWriter, accountHash, codeHash common.Hash, stat *generateStats) (common.Hash, error) {
...
func generateTrieRoot(db sildb.KeyValueWriter, scheme string, it Iterator, account common.Hash, generatorFn trieGeneratorFn, leafCallback leafCallbackFn, stats *generateStats, report bool) (common.Hash, error) {
	var (
...
func stackTrieGenerate(db sildb.KeyValueWriter, scheme string, owner common.Hash, in chan trieKV, out chan common.Hash) {
