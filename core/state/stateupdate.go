...
// AccountDelete represents a deletion operation for an Sila account.
...
// AccountUpdate represents an update operation for an Sila account.
...
// key-value mappings, using the same encoding rules as the Sila state trie.
