...
func TestBlockEncoding(t *testing.T) {
	...
	tx1, _ = tx1.WithSignature(SilaHomesteadSigner{}, common.Hex2Bytes("9bea4c4daac7c7c52e093e6a4c35dbbcf8856f1af7b059ba20253e70848d094f8a8fae537ce25ed8cb5af9adac3f141af69bd515bd2ba031522df09b97dd72b100"))
...
func TestSIP1559BlockEncoding(t *testing.T) {
...
func TestSIP2718BlockEncoding(t *testing.T) {
	...
	tx1, _ = tx1.WithSignature(SilaHomesteadSigner{}, sig)
	...
	tx2, _ = tx2.WithSignature(NewSIP2930Signer(big.NewInt(1)), sig2)
...
func TestSIP4844BlockEncoding(t *testing.T) {
	// https://github.com/sila-chain/tests/blob/develop/BlockchainTests/ValidBlocks/bcSIP4844-blobtransactions/blockWithAllTransactionTypes.json
...
func TestRlpDecodeParentHash(t *testing.T) {
	...
	silaMainnetTd := new(big.Int)
	silaMainnetTd.SetString("5ad3c2c71bbff854908", 16)
	if rlpData, err := rlp.EncodeToBytes(&Header{
		ParentHash: want,
		Difficulty: silaMainnetTd,
