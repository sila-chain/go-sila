...
// SilTransferLog creates and SIL transfer log according to SIP-7708.
// Specification: https://sips.sila.org/SIPS/sip-7708
func SilTransferLog(from, to common.Address, amount *uint256.Int) *Log {
	amount32 := amount.Bytes32()
	return &Log{
		Address: params.SystemAddress,
		Topics: []common.Hash{
			params.SilTransferLogEvent,
