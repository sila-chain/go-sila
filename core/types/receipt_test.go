...
func TestReceiptMarshalBinary(t *testing.T) {
	...
	// 1559 Receipt
	buf.Reset()
	sip1559Receipt.Bloom = CreateBloom(sip1559Receipt)
	have, err = sip1559Receipt.MarshalBinary()
	if err != nil {
		t.Fatalf("marshal binary error: %v", err)
	}
	sip1559Receipts := Receipts{sip1559Receipt}
	sip1559Receipts.EncodeIndex(0, buf)
	haveEncodeIndex = buf.Bytes()
	if !bytes.Equal(have, haveEncodeIndex) {
		t.Errorf("BinaryMarshal and EncodeIndex mismatch, got %x want %x", have, haveEncodeIndex)
	}
	sip1559Want := common.FromHex("")
	if !bytes.Equal(have, sip1559Want) {
		t.Errorf("encoded RLP mismatch, got %x want %x", have, sip1559Want)
	}
}
...
func TestReceiptUnmarshalBinary(t *testing.T) {
	...
	// 1559 Receipt
	sip1559RctBinary := common.FromHex("")
	got1559Receipt := new(Receipt)
	if err := got1559Receipt.UnmarshalBinary(sip1559RctBinary); err != nil {
		t.Fatalf("unmarshal binary error: %v", err)
	}
	sip1559Receipt.Bloom = CreateBloom(sip1559Receipt)
	if !reflect.DeepEqual(got1559Receipt, sip1559Receipt) {
		t.Errorf("receipt unmarshalled from binary mismatch, got %v want %v", got1559Receipt, sip1559Receipt)
	}
}
