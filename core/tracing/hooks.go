...
// invoked by the go-sila core at various points in the state transition.
//
// To create a tracer that can be invoked with Sila, you need to register it using
// [github.com/sila-chain/go-sila/sil/tracers.LiveDirectory.Register].
//
// See https://sila.org/docs/developers/evm-tracing/live-tracing for a tutorial.
package tracing
...
type (
	...
	*/
	...
	// Exceptionally, before the sila_homestead hardfork a contract creation that
...
const (
	...
	// GasChangeTxDataFloor is the extra gas charged to meet the SIP-7623
...
const (
	...
	// CodeChangeAuthorizationClear is when SIP-7702 delegation is cleared by
