...
- `OnCodeChange(addr common.Address, prevCodeHash common.Hash, prevCode []byte, codeHash common.Hash, code []byte)`: This hook is deprecated in favor of `OnCodeChangeV2` which includes a reason parameter ([#32525](https://github.com/sila-chain/go-sila/pull/32525)).

### New methods

- `OnCodeChangeV2(addr common.Address, prevCodeHash common.Hash, prevCode []byte, codeHash common.Hash, code []byte, reason CodeChangeReason)`: This hook is called when a code change occurs. It is a successor to `OnCodeChange` with an additional reason parameter ([#32525](https://github.com/sila-chain/go-sila/pull/32525)).

### New types

- `CodeChangeReason` is a new type used to provide a reason for code changes. It includes various reasons such as contract creation, genesis initialization, SIP-7702 authorization, self-destruct, and revert operations ([#32525](https://github.com/sila-chain/go-sila/pull/32525)).

## [v1.15.4](https://github.com/sila-chain/go-sila/releases/tag/v1.15.4)

### Modified types

- `GasChangeReason` has been extended with auto-generated String() methods for better debugging and logging ([#31234](https://github.com/sila-chain/go-sila/pull/31234)).
- `NonceChangeReason` has been extended with auto-generated String() methods for better debugging and logging ([#31234](https://github.com/sila-chain/go-sila/pull/31234)).

## [v1.15.0](https://github.com/sila-chain/go-sila/releases/tag/v1.15.0)
...
- `BlockEvent` has been modified:
  - The `TD` (Total Difficulty) field has been removed ([#30744](https://github.com/sila-chain/go-sila/pull/30744)).
...
## [v1.14.12](https://github.com/sila-chain/go-sila/releases/tag/v1.14.12)
...
- `VMContext.StateDB` has been extended with the following method:
  - `GetTransientState(addr common.Address, slot common.Hash) common.Hash` method used to access contract transient storage ([#30531](https://github.com/sila-chain/go-sila/pull/30531)).
...
## [v1.14.10](https://github.com/sila-chain/go-sila/releases/tag/v1.14.10)

### Modified types

- `OpContext` has been extended with the following method:
  - `ContractCode() []byte` provides access to the contract bytecode within the OpContext interface ([#30466](https://github.com/sila-chain/go-sila/pull/30466)).

## [v1.14.9](https://github.com/sila-chain/go-sila/releases/tag/v1.14.9)
...
[unreleased]: https://github.com/sila-chain/go-sila/compare/v1.16.3...master
[v1.15.4]: https://github.com/sila-chain/go-sila/releases/tag/v1.15.4
[v1.15.0]: https://github.com/sila-chain/go-sila/releases/tag/v1.15.0
[v1.14.12]: https://github.com/sila-chain/go-sila/releases/tag/v1.14.12
[v1.14.10]: https://github.com/sila-chain/go-sila/releases/tag/v1.14.10
[v1.14.9]: https://github.com/sila-chain/go-sila/releases/tag/v1.14.9
[v1.14.4]: https://github.com/sila-chain/go-sila/releases/tag/v1.14.4
[v1.14.3]: https://github.com/sila-chain/go-sila/releases/tag/v1.14.3
[v1.14.0]: https://github.com/sila-chain/go-sila/releases/tag/v1.14.0
