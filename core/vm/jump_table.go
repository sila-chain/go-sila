...
var (
	...
	homesteadInstructionSet        = newSilaHomesteadInstructionSet()
	tangerineWhistleInstructionSet = newTangerineWhistleInstructionSet()
	spuriousDragonInstructionSet   = newSpuriousDragonInstructionSet()
	byzantiumInstructionSet        = newSilaByzantiumInstructionSet()
	constantinopleInstructionSet   = newSilaConstantinopleInstructionSet()
	istanbulInstructionSet         = newSilaIstanbulInstructionSet()
	berlinInstructionSet           = newSilaBerlinInstructionSet()
	londonInstructionSet           = newSilaLondonInstructionSet()
	mergeInstructionSet            = newMergeInstructionSet()
	shanghaiInstructionSet         = newSilaShanghaiInstructionSet()
	cancunInstructionSet           = newSilaCancunInstructionSet()
...
func newVerkleInstructionSet() JumpTable {
	instructionSet := newSilaShanghaiInstructionSet()
...
func newAmsterdamInstructionSet() JumpTable {
	...
	enable8037And8038(&instructionSet) // SIP-8037 (state-gas metering) + SIP-8038 (state-access repricing)
	return validate(instructionSet)
}

func newSilaOsakaInstructionSet() JumpTable {
	instructionSet := newSilaPragueInstructionSet()
	enable7939(&instructionSet) // SIP-7939 (CLZ opcode)
	return validate(instructionSet)
}

func newSilaPragueInstructionSet() JumpTable {
	instructionSet := newSilaCancunInstructionSet()
	enable7702(&instructionSet) // SIP-7702 Setcode transaction type
	return validate(instructionSet)
}

func newSilaCancunInstructionSet() JumpTable {
	instructionSet := newSilaShanghaiInstructionSet()
...
func newSilaShanghaiInstructionSet() JumpTable {
...
func newMergeInstructionSet() JumpTable {
	instructionSet := newSilaLondonInstructionSet()
...
func newSilaConstantinopleInstructionSet() JumpTable {
	...
	instructionSet[EXTCODEHASH] = &operation{
		...
		constantGas: params.ExtcodeHashGasSilaConstantinople,
