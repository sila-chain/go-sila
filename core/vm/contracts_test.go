...
var allPrecompiles = map[common.Address]PrecompiledContract{
	...
	common.BytesToAddress([]byte{6}):    &bn256AddSilaIstanbul{},
	common.BytesToAddress([]byte{7}):    &bn256ScalarMulSilaIstanbul{},
	common.BytesToAddress([]byte{8}):    &bn256PairingSilaIstanbul{},
