...
func TestProcessUBT(t *testing.T) {
	var (
		...
		intrinsicContractCreationGas, _ = IntrinsicGas(code, nil, nil, common.Address{}, nil, nil, params.Rules{IsSilaHomestead: true, IsSilaIstanbul: true, IsSilaShanghai: true})
		...
		intrinsicCodeWithExtCodeCopyGas, _ = IntrinsicGas(codeWithExtCodeCopy, nil, nil, common.Address{}, nil, nil, params.Rules{IsSilaHomestead: true, IsSilaIstanbul: true, IsSilaShanghai: true})
