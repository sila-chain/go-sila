...
func (db *Database) loadJournal(diskRoot common.Hash) (layer, error) {
	...
	// It can happen that sila crashes without persisting the journal.
...
func loadGenerator(db sildb.KeyValueReader, hash nodeHasher) (*journalGenerator, common.Hash, error) {
