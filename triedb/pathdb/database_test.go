...
func TestCorruptedJournal(t *testing.T) {
	testCorruptedJournal(t, "", func(db sildb.Database) {
	...
	testCorruptedJournal(t, directory, func(_ sildb.Database) {
...
func testCorruptedJournal(t *testing.T, journalDir string, modifyFn func(database sildb.Database)) {
	// Redefine the diff layer depth allowance for faster testing.
	maxDiffLayers = 4
	defer func() {
		maxDiffLayers = 128
