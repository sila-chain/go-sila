...
func readStateHistoryMeta(reader sildb.AncientReader, id uint64) (*meta, error) {
...
func readStateHistory(reader sildb.AncientReader, id uint64) (*stateHistory, error) {
...
func readStateHistories(freezer sildb.AncientReader, start uint64, count uint64) ([]history, error) {
...
func writeStateHistory(writer sildb.AncientWriter, dl *diffLayer) error {
...
func checkStateHistories(reader sildb.AncientReader, start, count uint64, check func(*meta) error) error {
	for count > 0 {
		number := count
		if number > 10000 {
