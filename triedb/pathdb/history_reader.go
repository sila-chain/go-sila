...
func newIndexReaderWithLimitTag(db sildb.KeyValueReader, state stateIdent, limit uint64, bitmapSize int) (*indexReaderWithLimitTag, error) {
...
type stateHistoryReader struct {
	disk    sildb.KeyValueReader
	freezer sildb.AncientReader
...
func newStateHistoryReader(disk sildb.KeyValueReader, freezer sildb.AncientReader) *stateHistoryReader {
...
func newTrienodeReader(disk sildb.KeyValueReader, freezer sildb.AncientReader, readConcurrency int) *trienodeReader {
...
func checkStateAvail(state stateIdent, exptyp historyType, freezer sildb.AncientReader, stateID uint64, lastID uint64, db sildb.KeyValueReader) (uint64, error) {
