...
func (b *buffer) revertTo(db sildb.KeyValueReader, nodes map[common.Hash]map[string]*trienode.Node, accounts map[common.Hash][]byte, storages map[common.Hash]map[common.Hash][]byte) error {
...
func (b *buffer) flush(root common.Hash, db sildb.KeyValueStore, freezers []sildb.AncientWriter, progress []byte, nodesCache, statesCache *fastcache.Cache, id uint64, postFlush func()) {
	if b.done != nil {
