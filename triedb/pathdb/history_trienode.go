...
type singleTrienodeHistoryReader struct {
	id         uint64
	reader     sildb.AncientReader
	keyData    []byte
	valueRange iRange
}

func newSingleTrienodeHistoryReader(id uint64, reader sildb.AncientReader, keyRange iRange, valueRange iRange) (*singleTrienodeHistoryReader, error) {
...
type trienodeHistoryReader struct {
	...
	reader sildb.AncientReader // Database reader of ancient store
}

// newTrienodeHistoryReader constructs the reader for specific trienode history.
func newTrienodeHistoryReader(id uint64, reader sildb.AncientReader) *trienodeHistoryReader {
...
func writeTrienodeHistory(writer sildb.AncientWriter, dl *diffLayer, rate uint32) error {
	start := time.Now()
...
func readTrienodeMetadata(reader sildb.AncientReader, id uint64) (*trienodeMetadata, error) {
...
func readTrienodeHistory(reader sildb.AncientReader, id uint64) (*trienodeHistory, error) {
...
func readTrienodeHistories(reader sildb.AncientReader, start uint64, count uint64) ([]history, error) {
