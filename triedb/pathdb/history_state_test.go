...
func checkStateHistory(t *testing.T, freezer sildb.AncientReader, id uint64, exist bool) {
...
func checkHistoriesInRange(t *testing.T, freezer sildb.AncientReader, from, to uint64, exist bool) {
