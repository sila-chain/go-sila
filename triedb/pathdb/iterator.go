...
func newDiskAccountIterator(db sildb.KeyValueStore, seek common.Hash) AccountIterator {
...
func newDiskStorageIterator(db sildb.KeyValueStore, account common.Hash, seek common.Hash) StorageIterator {
	pos := common.TrimRightZeroes(seek[:])
