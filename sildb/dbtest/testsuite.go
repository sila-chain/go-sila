...
// implementation.
func TestDatabaseSuite(t *testing.T, New func() sildb.KeyValueStore) {
...
// implementation.
func BenchDatabaseSuite(b *testing.B, New func() sildb.KeyValueStore) {
	var (
...
func iterateKeys(it sildb.Iterator) []string {
	keys := []string{}
	for it.Next() {
