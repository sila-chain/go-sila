...
func (d *Database) NewBatch() sildb.Batch {
	return &batch{
		b:  d.db.NewBatch(),
		db: d,
	}
...
func (d *Database) NewBatchWithSize(size int) sildb.Batch {
	return &batch{
...
func (b *batch) Replay(w sildb.KeyValueWriter) error {
	reader := b.b.Reader()
	for {
...
func (d *Database) NewIterator(prefix []byte, start []byte) sildb.Iterator {
