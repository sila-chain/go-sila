...
// Package utils contains internal helper functions for go-sila commands.
package utils
...
import (
	...
	"github.com/sila-chain/go-sila/ethdb/remotedb"
...
var (
	...
	SilRequiredBlocksFlag = &cli.StringFlag{
		Name:     "sil.requiredblocks",
	...
	SyncModeFlag = &cli.StringFlag{
		...
		Value:    silconfig.Defaults.SyncMode.String(),
	...
	SnapV2Flag = &cli.BoolFlag{
		...
		Value:    silconfig.Defaults.SnapV2,
		Category: flags.StateCategory,
	}
	...
	StateHistoryFlag = &cli.Uint64Flag{
		...
		Value:    silconfig.Defaults.StateHistory,
		Category: flags.StateCategory,
	}
	TrienodeHistoryFlag = &cli.Int64Flag{
		...
		Value:    silconfig.Defaults.TrienodeHistory,
		Category: flags.StateCategory,
	}
	TrienodeHistoryFullValueCheckpointFlag = &cli.UintFlag{
		...
		Value:    uint(silconfig.Defaults.NodeFullValueCheckpoint),
		Category: flags.StateCategory,
	}
	TransactionHistoryFlag = &cli.Uint64Flag{
		Name:     "history.transactions",
		Usage:    "Number of recent blocks to maintain transactions index for (default = about one year, 0 = entire chain)",
		Value:    silconfig.Defaults.TransactionHistory,
		Category: flags.StateCategory,
	}
	...
	LogHistoryFlag = &cli.Uint64Flag{
		...
		Value:    silconfig.Defaults.LogHistory,
		Category: flags.StateCategory,
	}
	...
	TxPoolJournalFlag = &cli.StringFlag{
		...
		Value:    silconfig.Defaults.TxPool.Journal,
		Category: flags.TxPoolCategory,
	}
	TxPoolRejournalFlag = &cli.DurationFlag{
		Name:     "txpool.rejournal",
		Usage:    "Time interval to regenerate the local transaction journal",
		Value:    silconfig.Defaults.TxPool.Rejournal,
		Category: flags.TxPoolCategory,
	}
	TxPoolPriceLimitFlag = &cli.Uint64Flag{
		Name:     "txpool.pricelimit",
		Usage:    "Minimum gas price tip to enforce for acceptance into the pool",
		Value:    silconfig.Defaults.TxPool.PriceLimit,
		Category: flags.TxPoolCategory,
	}
	TxPoolPriceBumpFlag = &cli.Uint64Flag{
		Name:     "txpool.pricebump",
		Usage:    "Price bump percentage to replace an already existing transaction",
		Value:    silconfig.Defaults.TxPool.PriceBump,
		Category: flags.TxPoolCategory,
	}
	TxPoolAccountSlotsFlag = &cli.Uint64Flag{
		Name:     "txpool.accountslots",
		Usage:    "Minimum number of executable transaction slots guaranteed per account",
		Value:    silconfig.Defaults.TxPool.AccountSlots,
		Category: flags.TxPoolCategory,
	}
	TxPoolGlobalSlotsFlag = &cli.Uint64Flag{
		Name:     "txpool.globalslots",
		Usage:    "Maximum number of executable transaction slots for all accounts",
		Value:    silconfig.Defaults.TxPool.GlobalSlots,
		Category: flags.TxPoolCategory,
	}
	TxPoolAccountQueueFlag = &cli.Uint64Flag{
		Name:     "txpool.accountqueue",
		Usage:    "Maximum number of non-executable transaction slots permitted per account",
		Value:    silconfig.Defaults.TxPool.AccountQueue,
		Category: flags.TxPoolCategory,
	}
	TxPoolGlobalQueueFlag = &cli.Uint64Flag{
		Name:     "txpool.globalqueue",
		Usage:    "Maximum number of non-executable transaction slots for all accounts",
		Value:    silconfig.Defaults.TxPool.GlobalQueue,
		Category: flags.TxPoolCategory,
	}
	TxPoolLifetimeFlag = &cli.DurationFlag{
		Name:     "txpool.lifetime",
		Usage:    "Maximum amount of time non-executable transaction are queued",
		Value:    silconfig.Defaults.TxPool.Lifetime,
		Category: flags.TxPoolCategory,
	}
	...
	BlobPoolDataDirFlag = &cli.StringFlag{
		...
		Value:    silconfig.Defaults.BlobPool.Datadir,
	...
	BlobPoolDataCapFlag = &cli.Uint64Flag{
		...
		Value:    silconfig.Defaults.BlobPool.Datacap,
		Category: flags.BlobPoolCategory,
	}
	...
	CacheLogSizeFlag = &cli.IntFlag{
		...
		Category: flags.PerfCategory,
		Value:    silconfig.Defaults.FilterLogCacheSize,
	}
	...
	MinerGasLimitFlag = &cli.Uint64Flag{
		...
		Value:    silconfig.Defaults.Miner.GasCeil,
		Category: flags.MinerCategory,
	}
	MinerGasPriceFlag = &flags.BigFlag{
		Name:     "miner.gasprice",
		Usage:    "Minimum gas price for mining a transaction",
		Value:    silconfig.Defaults.Miner.GasPrice,
		Category: flags.MinerCategory,
	}
	...
	MinerRecommitIntervalFlag = &cli.DurationFlag{
		...
		Value:    silconfig.Defaults.Miner.Recommit,
		Category: flags.MinerCategory,
	}
	...
	RPCGlobalGasCapFlag = &cli.Uint64Flag{
		Name:     "rpc.gascap",
		Usage:    "Sets a cap on gas that can be used in sil_call/estimateGas (0=infinite)",
	...
	RPCGlobalLogQueryLimit = &cli.IntFlag{
		...
		Usage:    "Maximum number of alternative addresses or topics allowed per search position in sil_getLogs filter criteria (0 = no cap)",
		Value:    silconfig.Defaults.LogQueryLimit,
		Category: flags.APICategory,
	}
	RPCTxSyncDefaultTimeoutFlag = &cli.DurationFlag{
		Name:     "rpc.txsync.defaulttimeout",
		Usage:    "Default timeout for sil_sendRawTransactionSync (e.g. 2s, 500ms)",
		Value:    silconfig.Defaults.TxSyncDefaultTimeout,
		Category: flags.APICategory,
	}
	RPCTxSyncMaxTimeoutFlag = &cli.DurationFlag{
		Name:     "rpc.txsync.maxtimeout",
		Usage:    "Maximum allowed timeout for sil_sendRawTransactionSync (e.g. 5m)",
		Value:    silconfig.Defaults.TxSyncMaxTimeout,
		Category: flags.APICategory,
	}
	...
	SilStatsURLFlag = &cli.StringFlag{
		Name:     "silstats",
		Usage:    "Reporting URL of a silstats service (nodename:secret@host:port)",
	...
	LogSlowBlockFlag = &cli.DurationFlag{
		...
		Value:    silconfig.Defaults.SlowBlockThreshold,
		Category: flags.LoggingCategory,
	}
	...
	GpoBlocksFlag = &cli.IntFlag{
		...
		Value:    silconfig.Defaults.GPO.Blocks,
		Category: flags.GasPriceCategory,
	}
	GpoPercentileFlag = &cli.IntFlag{
		Name:     "gpo.percentile",
		Usage:    "Suggested gas price is the given percentile of a set of recent transaction gas prices",
		Value:    silconfig.Defaults.GPO.Percentile,
		Category: flags.GasPriceCategory,
	}
	GpoMaxGasPriceFlag = &cli.Int64Flag{
		Name:     "gpo.maxprice",
		Usage:    "Maximum transaction priority fee (or gasprice before SilaLondon fork) to be recommended by gpo",
		Value:    silconfig.Defaults.GPO.MaxPrice.Int64(),
		Category: flags.GasPriceCategory,
	}
	GpoIgnoreGasPriceFlag = &cli.Int64Flag{
		Name:     "gpo.ignoreprice",
		Usage:    "Gas price below which gpo will ignore transactions",
		Value:    silconfig.Defaults.GPO.IgnorePrice.Int64(),
		Category: flags.GasPriceCategory,
	}
...
func SetP2PConfig(ctx *cli.Context, cfg *p2p.Config) {
	...
	silPeers := cfg.MaxPeers
	log.Info("Maximum peer count", "SIL", silPeers, "total", cfg.MaxPeers)
...
func setRequiredBlocks(ctx *cli.Context, cfg *silconfig.Config) {
	requiredBlocks := ctx.String(SilRequiredBlocksFlag.Name)
	if requiredBlocks == "" {
		return
	}
...
func SetSilConfig(ctx *cli.Context, stack *node.Node, cfg *silconfig.Config) {
	...
	if cfg.TransactionHistory == silconfig.Defaults.TransactionHistory && cfg.TxLookupLimit != silconfig.Defaults.TxLookupLimit {
	...
	if !ctx.Bool(SnapshotFlag.Name) || cfg.SnapshotCache == 0 {
		...
		if cfg.SyncMode == silconfig.SnapSync {
...
// no URLs are set.
func SetDNSDiscoveryDefaults(cfg *silconfig.Config, genesis common.Hash) {
	if cfg.SilDiscoveryURLs != nil {
		return // already set through flags/config
	}
	protocol := "all"
	if url := params.KnownDNSNetwork(genesis, protocol); url != "" {
		cfg.SilDiscoveryURLs = []string{url}
		cfg.SnapDiscoveryURLs = cfg.SilDiscoveryURLs
	}
}
...
func RegisterGraphQLService(stack *node.Node, backend silapi.Backend, filterSystem *filters.FilterSystem, cfg *node.Config) {
...
// RegisterFilterAPI adds the sil log filtering RPC API to the node.
func RegisterFilterAPI(stack *node.Node, backend silapi.Backend, ethcfg *silconfig.Config) *filters.FilterSystem {
...
func RegisterSyncOverrideService(stack *node.Node, sil *sil.Sila, config syncer.Config) {
	...
	syncer.Register(stack, sil, config)
}
...
func MakeChainDatabase(ctx *cli.Context, stack *node.Node, readonly bool) sildb.Database {
	var (
...
func tryMakeReadOnlyDatabase(ctx *cli.Context, stack *node.Node) sildb.Database {
...
func MakeChain(ctx *cli.Context, stack *node.Node, readonly bool) (*core.BlockChain, sildb.Database) {
	var (
	...
	engine, err := silconfig.CreateConsensusEngine(config, chainDb)
	if err != nil {
		Fatalf("%v", err)
	}
	if gcmode := ctx.String(GCModeFlag.Name); gcmode != "full" && gcmode != "archive" {
	...
	options := &core.BlockChainConfig{
		...
		SnapshotLimit:           silconfig.Defaults.SnapshotCache,
...
func MakeTrieDatabase(ctx *cli.Context, stack *node.Node, disk sildb.Database, preimage bool, readOnly bool, isUBT bool) *triedb.Database {
