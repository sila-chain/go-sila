...
func TestBlockchain(t *testing.T) {
	...
	bt.slow(`.*bcExploitTest/SilaShanghaiLove.json`)
	...
	bt.skipLoad(`^GeneralStateTests/stSStoreTest/InitCollision\\.json// Copyright 2015 The go-sila Authors
// This file is part of the go-sila library.
//
// The go-sila library is free software: you can redistribute it and/or modify
// it under the terms of the GNU Lesser General Public License as published by
...
func TestBlockchain(t *testing.T) {
	...
	bt.skipLoad(`^GeneralStateTests/stExtCodeHash/dynamicAccountOverwriteEmpty\\.json// Copyright 2015 The go-sila Authors
// This file is part of the go-sila library.
//
// The go-sila library is free software: you can redistribute it and/or modify
// it under the terms of the GNU Lesser General Public License as published by
...
func TestBlockchain(t *testing.T) {
	...
	bt.skipLoad(`^GeneralStateTests/stCreate2/create2collisionStorage\\.json// Copyright 2015 The go-sila Authors
// This file is part of the go-sila library.
//
// The go-sila library is free software: you can redistribute it and/or modify
// it under the terms of the GNU Lesser General Public License as published by
...
func TestBlockchain(t *testing.T) {
	...
	bt.skipLoad(`^ValidBlocks/bcTotalDifficultyTest/lotsOfLeafs\\.json// Copyright 2015 The go-sila Authors
// This file is part of the go-sila library.
//
// The go-sila library is free software: you can redistribute it and/or modify
// it under the terms of the GNU Lesser General Public License as published by
