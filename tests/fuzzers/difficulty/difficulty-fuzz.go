...
func (f *fuzzer) fuzz() int {
	...
	for i, pair := range []struct {
		...
		{silash.FrontierDifficultyCalculator, silash.CalcDifficultyFrontierU256},
		{silash.SilaHomesteadDifficultyCalculator, silash.CalcDifficultySilaHomesteadU256},
		{silash.DynamicDifficultyCalculator(bombDelay), silash.MakeDifficultyCalculatorU256(bombDelay)},
	} {
