...
Please see [Releases](https://github.com/sila-chain/go-sila/releases). We recommend using the [most recently released version](https://github.com/sila-chain/go-sila/releases/latest).
...
To find out how to disclose a vulnerability in Sila visit [https://bounty.sila.org](https://bounty.sila.org) or email bounty@sila.org. Please read the [disclosure page](https://github.com/sila-chain/go-sila/security/advisories?state=published) for more information about publicly disclosed security vulnerabilities.
